...
2. Front Servers
    - 사용자의 요청에 맞는 웹 페이지나 서비스를 제공하며, Redis를 활용하여 장바구니, Dooray 인증번호 등의 임시 데이터를 캐시하거나 세션 데이터를 관리합니다.
3. Gateway Server
...
- MSA 구조로 각 서비스가 독립적으로 배포 및 관리됩니다. 이를 통해 서비스의 확장성과 유연성을 극대화하며, IaaS로 NHN Cloud를 활용하여 컴퓨팅 자원을 직접 운영하는 부담을 덜었습니다.
---
